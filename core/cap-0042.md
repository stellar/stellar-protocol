...
### XDR Changes
This patch of XDR changes is based on the XDR files in commit (`ecd0a7462c84bd1d2445cdfd48aa9b38b1bbfd20`) of stellar-core.
```diff mddiffcheck.base=ecd0a7462c84bd1d2445cdfd48aa9b38b1bbfd20
