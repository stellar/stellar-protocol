...
| [CAP-0051](cap-0051.md) | Smart Contract Host Functionality: Secp256r1 Verification | Leigh McCulloch | FCP: Accepted |
| [CAP-0053](cap-0053.md) | Separate host functions to extend the TTL for contract instance and contract code | Tommaso De Ponti | FCP: Accepted |
| [CAP-0054](cap-0054.md) | Soroban refined VM instantiation cost model | Graydon Hoare | FCP: Accepted |
| [CAP-0055](cap-0055.md) | Soroban streamlined linking | Graydon Hoare | FCP: Accepted |
| [CAP-0056](cap-0056.md) | Soroban intra-transaction module caching | Graydon Hoare | FCP: Accepted |
