...
```
CAP: To Be Assigned
Title: Soroban smart contract system, core-level overview
Working Group:
...
include members of the Horizon team, the teams building the Soroban SDK, CLI and
RPC server, Stellar and Soroban SDK developers, Soroban contract and application
developers, and Stellar network validator operators.
...
the following sub-CAPs:
  ...
  - [CAP-0046 - Smart Contract Runtime Environment](./cap-0046.md)
  ...
  - [CAP-0047 - Smart Contract Lifecycle](./cap-0047.md) covers the mechanism
    for creating smart contracts _and_ changes to the ledger to store
  ...
  - [CAP-0051 - Smart Contract Host Functions](./cap-0051.md) covers the new
    functions provided by the smart contract host to contracts. The semantics of
    some of these are specified in other topic-specific CAPs, but the central
    list of them will continue to live in CAP-0051.
  - [CAP-0052 - Smart Contract Interactions (miminal)](./cap-0052.md) covers
    the invocation interface for contracts _and_ sketches a standard token
    contract interface and authentication pattern.
  - [CAP-0053 - Smart Contract Data](./cap-0053.md) covers new ledger
    entries to store contract data.
  - [CAP-0054 - Smart Contract Standardized Asset](./cap-0054.md) covers the
    built-in token contract, that can also "wrap" existing Stellar assets.
  - [CAP-0055 - Fee Model in Smart Contracts](./cap-0055.md) covers changes
    to the network's fee-charging system to account for smart contracts.
  - [CAP-0056 - Smart Contract Logging](./cap-0056.md) covers changes to
    the transaction result, metadata, and ledger close metadata XDR to
