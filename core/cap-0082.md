...
```
{
    ...
    "return": "Val",
    "docs": "Performs checked addition. Computes `lhs + rhs`, returning `Void` if overflow occurred.",
...
},
{
    ...
    "return": "Val",
    "docs": "Performs checked subtraction. Computes `lhs - rhs`, returning `Void` if overflow occurred.",
    "min_supported_protocol": 26
},
{
    "export": "J",
    ...
    "return": "Val",
    "docs": "Performs checked multiplication. Computes `lhs * rhs`, returning `Void` if overflow occurred.",
    "min_supported_protocol": 26
},
{
    "export": "K",
    ...
    "return": "Val",
    "docs": "Performs checked exponentiation. Computes `lhs.exp(rhs)`, returning `Void` if overflow occurred.",
    "min_supported_protocol": 26
},
{
    "export": "L",
