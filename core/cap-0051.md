...
#### Host functions
```rust
/// Will save val to a list that will be returned to core so 
/// the logs can be put into TransactionMetaV3.logs with type ContractLogType::CONTRACT_INFO 
func $log(param $val i64) (result i64)

/// Internal host function. Same as log above but will use ContractLogType::SYSTEM instead
...
index 49d1c3c77..918da8450 100644
...
+
 ...
 {
     Hash hash;
@@ -321,6 +347,36 @@ struct TransactionMetaV2
                                         // applied if any
 };
