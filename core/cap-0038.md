...
index a21c577a..d56c7e9f 100644
...
+    } revokeId;
 ...
 enum MemoType
@@ -635,7 +704,28 @@ struct TransactionSignaturePayload
...
+
 ...
 {
     // emitted to identify the offer
@@ -651,6 +741,32 @@ struct ClaimOfferAtom
     int64 amountBought;
 };
...
@@ -745,7 +861,7 @@ union PathPaymentStrictReceiveResult switch (
...
@@ -789,7 +905,7 @@ union PathPaymentStrictSendResult switch (PathPaymentStrictSendResultCode code)
...
@@ -933,7 +1049,10 @@ enum ChangeTrustResultCode
