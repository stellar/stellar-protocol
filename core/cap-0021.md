...
index 0e7bc842..df371548 100644
...
@@ -126,6 +127,9 @@ const MAX_SIGNERS = 20;
...
+
 ...
 {
     uint32 numSponsored;
@@ -140,6 +144,19 @@ struct AccountEntryExtensionV2
     ext;
 };
...
+
 ...
 {
     Liabilities liabilities;
@@ -187,6 +204,8 @@ struct AccountEntry
         void;
     case 1:
         AccountEntryExtensionV1 v1;
+    case 3:
...
@@ -325,10 +344,10 @@ case CLAIM_PREDICATE_OR:
...
index e7b4218f..030a79de 100644
