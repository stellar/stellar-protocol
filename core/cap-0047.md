...
Note that there is no nonce, so `create_contract` can be replayed. This only
...
//     sha256("create_contract(contract: Vec<u8>, salt: u256, key: u256, sig: Vec<u8>)")
// Verifies that sha256(params) was signed by key
//     params = vec![CREATE_SEPARATOR, salt, contract]
//     key = key
//     sig = sig
// Creates a new contract.
fn create_contract(contract: Vec<u8>, salt: Vec<u8>, key: u256, sig: Vec<u8>) -> ContractID;
```
