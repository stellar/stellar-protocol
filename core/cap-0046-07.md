...
// Extended data (pushed to downstream systems) settings
...
{
    int64 ledgerMaxPropagateSizeBytes; // maximum size in bytes to propagate per ledger
    int64 txMaxSizeBytes; // maximum size in bytes for a transaction
