...
1. The Wallet checks the assets' conversion rate in [`SEP-38 GET /price`](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0038.md#get-price) and shows the expected price to the user.
1. The Wallet initiates a [`GET /deposit`](#deposit) using the parameters `asset_code` and `destination_asset`.
