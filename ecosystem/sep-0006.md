...
diagrams are opinionated. Variations of these flows may also be sufficient.
...
| `email_address`      | string                  | (optional) Email address of withdrawer. If desired, an anchor can use this to send email updates to the user about the withdrawal.                                                                                                                                                                                                                                                                                                                                    |
...
The anchor may choose to replace most of the digits in the `to` account number with `*`s to keep it confidential.
