...
`stellar_transaction_id` | string | The stellar transaction id of the transaction
`external_transaction_id` | string | The external transaction id of the transaction
