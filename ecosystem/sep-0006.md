...
* `pending_trust` -- completion of withdrawal requires user adding trust for the asset
...
* `no_market` -- could not complete withdrawal because no asset/XLM market was available to create the account
