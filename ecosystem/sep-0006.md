...
* Allow user to authenticate with issuer
...
* [`GET /federation?type=forward`](#withdraw): required
...
The wallet should also transmit one or more of the fields listed in [SEP-9](./sep-0009.md), depending on what the issuer has requested.
