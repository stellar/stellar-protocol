...
* **If the JWT is missing or invalid**: The anchor should display a login form allowing the user to authenticate manually. On success, the anchor should allow the deposit / withdrawal to proceed normally.
