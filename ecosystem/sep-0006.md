...
-----|------|------------
`asset_code` | string | The code of the off-chain asset the user wants to deposit with the anchor. The value passed must match one of the codes listed in the [/info](#info) response's deposit object.
...
Name | Type | Description
-----|------|------------
`id` | (optional) string | The id of the transaction.
