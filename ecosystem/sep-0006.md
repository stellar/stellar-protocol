...
| `fee_details`             | object              | (optional) Description of fee charged by the anchor. If `quote_id` was used, `fee_details` object should be equal to `quote.fee` object. The schema for this object is defined in the [Fee Details Object Schema](#fee-details-object-schema) section below.                                                                                                                                                                                                                                                                                                                                                                   |
