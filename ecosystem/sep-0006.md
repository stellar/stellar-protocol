...
### Callback Signature
In order to validate the integrity and provenance of the callback, the Anchor MUST include a signature in
...
- Specify a working callback URL via `STATUS_CALLBACK_URL` field of the [`stellar.toml`](sep-0001.md) file to the anchor.
