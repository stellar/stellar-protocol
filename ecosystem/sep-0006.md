...
* **For both deposit and withdrawal**:
    * The interactive flow has been deprecated, if you require an interactive flow use [SEP-24](sep-0024.md).  The following details are to understand legacy interactive flows.
...
The interactive flow has been [deprecated](#interactive-deprecation-notice) in favor of [SEP-24](sep-0024.md).
...
Note: The interactive flow has been deprecated, you should only need to implement this if you're trying to integrate with a legacy SEP-6 service that you know uses the interactive flow.
