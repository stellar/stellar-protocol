...
* **Interactive withdrawal**
    ...
    * When dealing with relatively unstable currencies, there might be slight fluctuations on value between the informed withdrawal `amount` and the actual transferred amount. It is recommended for anchors to accept a fluctuation of up to 10%, and  adjust the amount to be transferred (and fees) to reflect the actual value received.
