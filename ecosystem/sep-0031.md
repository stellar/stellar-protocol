...
### Successful Transaction with Firm Quote
...
sequenceDiagram
    ...
    Sender->>Sending Anchor: initiates send to <br> Recipient's country
    ...
    Sending Anchor->>+Sender: provides pair <br> est. rates & fees
    Sender-->>-Sending Anchor: selects asset pair
    ...
    loop once for Sender, once of Recipient
        note right of Sending Anchor: If Sender or Recipient <br >has already been <br> accepted, this section <br> is unnecessary.
        Sending Anchor->>+Receiving Anchor: GET [SEP-12]/customer?type=
        Receiving Anchor-->>-Sending Anchor: fields required
        Sending Anchor->>+Sender: requests fields
        Sender-->>-Sending Anchor: provides field values
    ...
    Sending Anchor->>+Sender: provides estimated rate
    Sender-->>-Sending Anchor: continues
    ...
    Receiving Anchor->>Recipient: Sends off-chain payment to recipient
    ...
    Sending Anchor->>Sender: notifies sender
```
