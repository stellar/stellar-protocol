...
* `receiver_sep12_type`: (optional) the default value of the `type` parameter used in `SEP-12 GET /customer` requests for customers receiving funds. This field can be omitted if no KYC is necessary.
