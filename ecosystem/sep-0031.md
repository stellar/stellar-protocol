...
`amount_fee` | string | (optional) The amount of fee charged by the Receiving Anchor. If a `quote_id` was used, fees should be detailed in the quote's `price_details` field.
