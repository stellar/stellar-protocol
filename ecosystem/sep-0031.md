...
per-customer fields provided via [SEP-9](sep-0009.md) fields in [SEP-12 PUT /customer](sep-0012.md#customer-put)
requests.
...
an error response. This approach is deprecated in favor of using per-customer fields provided via [SEP-9](sep-0009.md)
fields in [SEP-12 PUT /customer](sep-0012.md#customer-put) requests.
...
- `v2.7.0` Add `user_action_required_by` field to transaction responses
  ([#1486](https://github.com/stellar/stellar-protocol/pull/1486))
- `v2.6.0`: Add `fee_details` field to the transaction object
  ([#1441](https://github.com/stellar/stellar-protocol/pull/1441))
