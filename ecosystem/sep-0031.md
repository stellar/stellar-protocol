...
`amount_fee` | string | (optional) The amount of fee charged by the Receiving Anchor. If a `quote_id` was used, `amount_fee` field should be left empty and detailed in the quote's `price_details` field.
