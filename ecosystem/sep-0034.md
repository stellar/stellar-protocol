...
Stellar keypairs use their own encoding and representation, [strkey](https://godoc.org/github.com/stellar/go/strkey), but the raw bytes can be extracted and base64-encoded to get the values necessary for the JWK.
