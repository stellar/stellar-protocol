...
Stellar keypairs use their own encoding and representation, but the raw bytes can be extracted and base64-encoded to get the values necessary for the JWK.
