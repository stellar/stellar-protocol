...
A standard for contracts to self-describe their exported interface including
functions, events, and user-defined types.
...
An event spec entry describes a contract event that can be emitted by the
contract.
