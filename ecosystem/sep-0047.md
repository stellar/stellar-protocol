...
pub trait NonFungibleToken {
    ...
    /// * data - `[token_id: u128]`
    fn approve(e: &Env, approver: Address, approved: Address, token_id: u128, live_until_ledger: u32);
...
- `u128`: the identifier of the transferred token.
...
- `u128`: the identifier of the token.
...
- `bool`: whether approval was granted (`true`) or revoked (`false`).
- `u32`: the expiration ledger.
