...
### [sep26.authentications.[authenticationOption]] (Stellar.toml)

Authentication configuration parameters for each supported authentication protocol is defined under [sep26.authentications.[authenticationOption]].

The parameters to put here depend on each authentication protocol.
