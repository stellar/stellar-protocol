...
Field | Type | Description
------|------|------------|
`enabled`| boolean | Determines if deposits are supported or not. Wallet should consider deposits disabled if this field is not specified.
...
Field | Type | Description
------|------|------------|
`enabled`| boolean | Determines if transaction history is enabled is supported or not. Wallets should consider transaction history disabled if this field is not specified.
