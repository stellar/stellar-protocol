...
See the [BTC SEP-27 example response](#sep-27-asset-information-response) above of an asset that uses the choice type on a withdrawal field.
...
The first response, the success response, is explained below. The other possible responses are shared with the withdrawal endpoint, and are explained in the [KYC Documentation Required](#kyc-documentation-required) section below.
...
The first response, the success response, is explained below. The other possible responses are shared with the deposit endpoint, and are explained in the [KYC Documentation Required](#kyc-documentation-required) section below.
...
Name | Type | Description
-----|------|------------
`type` | string | Always set to `customer_info_needed`.
