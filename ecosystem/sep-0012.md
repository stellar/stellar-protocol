...
- Anchors and clients must support at least one of [SEP-10](sep-0010.md) or [SEP-45](sep-0045.md) web authentication and
  use it for all SEP-12 endpoints.

## API Endpoints

- [`GET /customer`](#customer-get): Check the status of a customer's info
