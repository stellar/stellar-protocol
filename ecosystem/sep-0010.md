...
* `exs` — boolen indicating if the account exists
...
The JWT may contain other claims specific to your application, see [RFC7519], or omit claims that will not be used in your scenarios.
