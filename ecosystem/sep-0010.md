...
* verify that transaction envelope is signed by a signer with weight 1 on the transaction's source account;
* verify that transaction envelope is signed by a signer with weight 1 on the manage data operation's source account;
