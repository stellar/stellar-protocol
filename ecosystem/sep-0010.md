...
This SEP also supports authenticating users of shared, omnibus, or pooled Stellar accounts. Clients can use [memos](#memos) or [muxed accounts](../core/cap-0027.md) to distinguish users or sub-accounts of shared accounts.
