...
* The server can verify that the client holds the secret key(s) of signers of their account
...
The JWT main contain additional claims to provide information about the state of the account, threshold of control, or signers.
