...
An anchor implementing [SEP-24] will let an authenticated user define the destination of withdrawn funds. This level of control is similar to the capability the destination of payments on the network which require a medium threshold.
