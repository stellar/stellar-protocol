...
* verify that transaction envelope has signatures with summed weight greater than the medium threshold on the transaction's source account;
* verify that transaction envelope has signatures with summed weight greater than the medium threshold on the operation's source account;
