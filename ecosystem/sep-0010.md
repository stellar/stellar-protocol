...
1. The client signs the transaction using the secret key(s) that control the user's Stellar account
...
1. The server compares the weight provided by the signers with the thresholds of the account against a minimum level of control required
