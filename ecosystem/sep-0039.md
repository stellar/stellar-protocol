...
| STRKEY\_SIGNED_PAYLOAD  | 15 << 3      | P          | no    | PK   |

No changes are made to the algorithms supported and the existing PK
...
https://github.com/leighmcculloch/xdrpp--stc/pull/1
...
The length prefix is to ensure that a truncated signed payload that has
a valid CRC is not considered valid.
