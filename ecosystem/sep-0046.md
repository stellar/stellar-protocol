...
This proposal describe a method to share Stellar Keys. The interface is an extension of the [SEP-5].
...
- guarantee that the secret can only be de cyphered using a given number of shares,
