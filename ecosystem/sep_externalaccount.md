...
SEP-58 introduces an External Account API for provisioning reusable inbound
...
Existing SEPs model deposits as transactions. SEP-58 introduces a first-class
...
- **[CAP-67: Unified Asset Events](../core/cap-0067.md).** Once CAP-67 is
  ...
  or in guidance for providers reconciling SEP-58 accounts with on-chain
  credits.
