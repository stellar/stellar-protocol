...
`organization.individual_beneficial_owners.{index}.title` | string | If an individual benefiacial owner is control person then this field will store the control person title. Field is optional
`organization.individual_beneficial_owners.{index}.ownership_percentage` | decimal |  Optional field , holds the percentage owned by the beneficial owner
`organization.entity_beneficial_owners.{index}.ownership_percentage` | decimal |  Optional field , holds the percentage owned by the beneficial owner
