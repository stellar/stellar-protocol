...
`address_country_code` | string        | country code | country code for current address                                                            
...
`organization.address_country_code` | string | country code | country code for current address
