...
Using [SEP-34](sep-0034.md), wallets can prove their identity to anchors for requests to process a particular transaction. This endpoint defines how the wallet should send the JWS token generated and returned from the wallet's signing server to the wallet application.
