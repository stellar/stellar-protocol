...
Name | Type | Description
-----|------|------------
`asset_code` | string | Code of the asset the user wants to withdraw. Ex if a user withdraws MyBTC tokens and receives native BTC, the `asset_code` must be MyBTC.
