...
| `account`                     | `G...` or `M...` string                 | (optional) The classic account, contract account or muxed account ID of the user that wants to deposit to. Defaults to the account used in authentication if not specified.                                                                                                                                                                                                                                                                                                               |
