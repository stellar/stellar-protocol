...
[Protocol
14/15](https://www.stellar.org/blog/protocol-14-improvements?locale=en) now allows anchors to
complete payments using the [ClaimableBalance
functionality](../core/cap-0023.md) and the user can collect the funds at any
time.
