...
### Shared, Omnibus, or Muxed Accounts
...
* **For both deposit and withdrawal**:
    * To start an interactive flow, provide the [Customer info needed response](#2-interactive-customer-information-needed).
...
## Changelog
* `v2.6.2`: Fixed the missing link of customer information needed. ([#1316](https://github.com/stellar/stellar-protocol/pull/1316))
