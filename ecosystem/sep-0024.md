...
1. The given Stellar `account` does not have a trustline to the asset's issuer account.
1. The `Anchor` proceeds with the deposit flow via the [CAP-0023](../core/cap-0023.md) Create Claimable Balance operation.
