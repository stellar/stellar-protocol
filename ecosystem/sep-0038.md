...
`buy_amount` | string | The amount of `buy_asset` the client would like to purchase for `sell_asset`.
...
`buy_amount` | string | The amount of `buy_asset` the anchor would like to purchase for `sell_asset`.
