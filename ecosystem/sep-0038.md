...
The prices returned include any margin that the provider may keep as a service fee, and this margin may vary depending on the directional flow of funds, amount, delivery method, country code, or other factors. Anchors can optionally detail the costs of the margin in the `fee_details` response field.
...
`amount` | string | The amount of asset applied.
...
The price returned includes any margin that the provider may keep as a service fee, and this margin may vary depending on the directional flow of funds, amount, delivery method, country code, or other factors. Anchors can optionally detail the costs of the margin in the `fee_details` response field.
...
The quote returned includes any margin that the provider may keep as a service fee, and this margin may vary depending on the directional flow of funds, the delivery method, amount, country code, or other factors. Anchors can optionally detail the costs of the margin in the `fee_details` response field.
