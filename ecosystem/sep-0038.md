...
| `sell_delivery_method` | string                                                                        | (optional) The method by which the user plans to deliver an off-chain asset to the anchor. This will only be present if specified in the request.                                                                                                                                        |
| `buy_asset`            | string                                                                        | The asset the client would like to exchange for `sell_asset`.                                                                                                                                                                                                                            |
...
| `buy_delivery_method`  | string                                                                        | (optional) The method by which the user plans to receive an off-chain asset from the anchor. This will only be present if specified in the request.                                                                                                                                      |
| `fee`                  | object                                                                        | An object describing the fee used to calculate the conversion price. This can be used to datail the price components for the end-user.                                                                                                                                                   |
