...
## Key considerations for proposing restriction on ledger keys
...
Here are the steps you should follow to draft a SLP. More details on the SLP process is in the [SLP README](limits/README.md).
...
Once you create a draft SLP, Core team will evaluate the proposal by setting the status to ["Awaiting Evaluation"](limits/README.md). 
...
## Evaluation Notes for SLP Committee to review
