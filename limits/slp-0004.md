...
Note, that there are many metadata consumers, so this benchmark can't be considered exhaustive. However, it represents a representative data point - even for a complex ingestion system it still takes <30% of the ledger time to ingest the increased metadata.
